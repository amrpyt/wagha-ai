...
- `.claude/skills/build-graph.md`: Build or update the code review knowledge graph. Run this first to initialize, or let hooks keep it updated automatically.

## code-review-graph Skill

- `.claude/skills/code-review-graph.md`: Use the code-review-graph MCP knowledge graph for structural code analysis, impact analysis, and token-efficient code review.

## Debug Issue

- `.claude/skills/debug-issue.md`: Systematically debug issues using graph-powered code navigation

## Explore Codebase

- `.claude/skills/explore-codebase.md`: Navigate and understand codebase structure using the knowledge graph
...
- `.claude/skills/refactor-safely.md`: Plan and execute safe refactoring using dependency analysis

## Review Changes

- `.claude/skills/review-changes.md`: Perform a structured code review using change detection and impact

## Review Delta

- `.claude/skills/review-delta.md`: Review only changes since last commit using impact analysis. Token-efficient delta review with automatic blast-radius detection.

## Review PR

- `.claude/skills/review-pr.md`: Review a PR or branch diff using the knowledge graph for full structural context. Outputs a structured review with blast-radius analysis.
